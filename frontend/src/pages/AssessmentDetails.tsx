...
export default function AssessmentDetails() {
    ...
    const highestScore = gradedSubmissions.length > 0
        ? Math.max(...gradedSubmissions.map(s => ((s.marks_obtained || 0) / (s.total_marks || 1)) * 100))
        : 0;
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-[#ebe8f2] dark:divide-white/5">
                                    ...
                                    {filteredSubmissions.map((sub) => {
                                        ...
                                        const hasSubmitted = sub.submitted_at !== null && sub.submitted_at !== undefined;
                                        const submittedDate = hasSubmitted && sub.submitted_at ? new Date(sub.submitted_at) : null;
