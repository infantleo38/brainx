...
export default function AssessmentAttempt() {
    ...
    useEffect(() => {
        const fetchAssessmentData = async () => {
            ...
            try {
                ...
                // Process questions
                let questionsArray: Question[] = assessmentData.questions?.questions || [];
    ...
    const handleSubmitExam = async () => {
        if (!assignmentId || !assessment) return;
        ...
        try {
            ...
            // Submit to backend
            const result: AssessmentResult = await assessmentsService.submitAssessment(assignmentId, answers);
