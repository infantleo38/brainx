...
export default function StudentAssignments() {
    ...
    const formatAssessments = (): FormattedAssessment[] => {
        return assessments.map(assessment => {
            const hasSubmitted = assessment.has_submitted || false;
            const hasGrade = hasSubmitted && assessment.marks_obtained !== null && assessment.marks_obtained !== undefined;
            ...
            return {
                ...
                course: assessment.course_name || 'Unknown Course',
                dueDate: dueText,
                status,
                statusColor,
                statusIcon,
