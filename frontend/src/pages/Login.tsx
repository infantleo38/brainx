        ...
        try {
            ...
            if (data.access_token) {
                ...
                try {
                    ...
                    if (returnTo) {
                        navigate(returnTo);
                    } else if (user.role === 'student' || (typeof user.role === 'string' && user.role.toLowerCase() === 'student')) {
                    ...
                    // Fallback to default dashboard if user fetch fails
                    const returnTo = location.state?.returnTo;
                    ...
                    <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
                        <div className="w-full max-w-md space-y-8">
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-slate-600">Enter your details to access your account</p>
                            </div>
                            ...
                            <form className="space-y-5" onSubmit={handleSubmit}>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-end">
                                        <a className="text-sm font-medium text-primary hover:text-primary-dark" href="#">Forgot Password?</a>
                                    </div>
                                </div>
                                <button
